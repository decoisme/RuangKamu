              ...
              >
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white px-3 text-[#9a9a9a]">Or continue with</span>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  type="button"
                  className="w-full py-3.5 rounded-xl bg-white border border-black/[0.08] text-[#0a0a0a] font-semibold flex items-center justify-center gap-3 hover:bg-[#f5f5f5] transition-colors cursor-pointer"
                >
